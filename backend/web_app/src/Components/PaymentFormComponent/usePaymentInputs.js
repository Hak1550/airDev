...
export default function usePaymentCard({
  ...
  const getCardImageProps = React.useCallback(
    (props = {}) => {
      ...
      const cardTypeDetails = props?.cardbrand ? props?.cardbrand : cardType;
      return {
        'aria-label': cardTypeDetails
          ? cardTypeDetails.displayName
          : 'Placeholder card',
        children:
          images[cardTypeDetails ? cardTypeDetails.type : 'placeholder'] ||
          images.placeholder,
        width: '1.5em',
        height: '1em',
        viewBox: '0 0 24 16',
